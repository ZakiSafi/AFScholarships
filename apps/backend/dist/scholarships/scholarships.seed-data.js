...
exports.SEED_TAG_DEFINITIONS = exports.SCHOLARSHIP_SEEDS = void 0;
const client_1 = require("@prisma/client");
exports.SCHOLARSHIP_SEEDS = [
    {
        slug: 'turkiye-burslari',
        title: 'Türkiye Bursları (Turkiye Scholarships)',
        summary: 'Fully funded undergraduate and graduate programs in Türkiye with tuition, stipend, and accommodation.',
        description: 'Türkiye Bursları is a government scholarship for international students to study at Turkish universities. Awards typically cover tuition, monthly stipend, accommodation, health insurance, and a one-time flight ticket. Programs are available in Turkish and English across many disciplines.',
    ...
    },
    {
        ...
        summary: 'Master’s degrees in development-related fields at German universities with full funding.',
        description: 'The DAAD EPOS program funds graduates from developing countries to pursue development-related master’s programs in Germany. Benefits include tuition, travel, monthly payments, insurance, and study allowances.',
    ...
    },
    {
        ...
        summary: 'UK government scholarships for one-year master’s degrees at British universities.',
        description: 'Chevening funds outstanding emerging leaders for a one-year master’s at any Chevening-eligible UK university. Covers tuition, monthly stipend, travel, and visa costs.',
    ...
    },
    {
        ...
        summary: 'Graduate study and research in the United States for international students.',
        description: 'The Fulbright Foreign Student Program enables graduate students and young professionals to study and conduct research in the U.S. Funding and eligibility are managed by Fulbright commissions or U.S. embassies in each country.',
    ...
    },
    {
        ...
        summary: 'Japanese government scholarships for undergraduate and research students.',
        description: 'MEXT scholarships support international students for undergraduate, master’s, and research programs at Japanese universities. Benefits include tuition, monthly allowance, and travel.',
        provider: 'Ministry of Education, Culture, Sports, Science and Technology (Japan)',
        hostCountry: 'Japan',
        degreeLevel: client_1.DegreeLevel.BACHELOR,
        fundingType: client_1.FundingType.FULL,
    ...
    },
    {
        ...
        summary: 'Study in two or more European countries with a joint degree and mobility grant.',
        description: 'Erasmus Mundus Joint Master Programs (EMJMD) offer integrated study across European universities. Scholarships cover participation costs, travel, and living allowance for top-ranked applicants.',
    ...
    },
    {
        ...
        summary: 'Merit-based awards for bachelor’s and master’s study at Qatar University.',
        description: 'Qatar University offers competitive scholarships for international students including tuition support and stipends for qualified applicants in select colleges.',
        provider: 'Qatar University',
        hostCountry: 'Qatar',
        degreeLevel: client_1.DegreeLevel.BACHELOR,
        fundingType: client_1.FundingType.PARTIAL,
    ...
    },
    {
        ...
        summary: 'Long-term development scholarships for study in Australia from partner countries.',
        description: 'Australia Awards support individuals from developing countries to undertake full-time study at participating Australian institutions. Focus on fields that contribute to development priorities.',
    ...
    },
    {
        ...
        summary: 'Prestigious doctoral scholarships for leadership and research excellence in Canada.',
        description: 'The Vanier CGS program helps Canadian institutions attract highly qualified doctoral students. Nominees must be nominated by a Canadian university with a Vanier quota.',
        provider: 'Government of Canada',
        hostCountry: 'Canada',
        degreeLevel: client_1.DegreeLevel.PHD,
        fundingType: client_1.FundingType.FULL,
    ...
    },
    {
        ...
        summary: 'Master’s scholarships for professionals from eligible countries to study in Sweden.',
        description: 'The Swedish Institute (SI) scholarships cover tuition and living expenses for master’s programs starting in Sweden. Targeted at applicants with demonstrated work and leadership experience.',
    ...
    },
    {
        ...
        summary: 'Dutch-funded scholarships for mid-career professionals from OKP countries.',
        description: 'The Orange Knowledge Programme offers funding for short courses and master’s programs in the Netherlands, focusing on capacity building in eligible countries.',
    ...
    },
    {
        ...
        summary: 'Korean government scholarship for undergraduate and graduate study in Korea.',
        description: 'GKS (formerly KGSP) supports international students for degree programs at designated Korean universities with airfare, tuition, settlement allowance, and monthly stipend.',
    ...
    },
    {
        ...
        summary: 'Hungarian government scholarship for bachelor’s, master’s, and PhD study.',
        description: 'Stipendium Hungaricum offers tuition-free study at Hungarian universities with monthly stipend, dormitory place or housing contribution, and medical insurance.',
    ...
    },
    {
        ...
        summary: 'French Ministry scholarship for master’s and PhD applicants to French institutions.',
        description: 'The Eiffel Programme supports future foreign decision-makers in priority areas. French higher education institutions submit applications on behalf of candidates.',
    ...
    },
    {
        ...
        summary: 'Comprehensive scholarships at partner universities for academically talented youth.',
        description: 'The Mastercard Foundation Scholars Program provides holistic support—tuition, living expenses, leadership training—at partner institutions across Africa and globally.',
    ...
    },
    {
        ...
        summary: 'UK master’s scholarships for students from lower and middle income Commonwealth countries.',
        description: 'Funded by the UK FCDO, Shared Scholarships cover tuition and living costs for master’s study on selected courses at participating UK universities.',
    ...
    },
    {
        ...
        summary: 'Study opportunities in Norway for students from developing countries in the Quota Scheme.',
        description: 'The Quota Scheme supports students from partner countries at bachelor’s and master’s level at participating Norwegian institutions, covering living costs and travel for eligible recipients.',
    ...
    },
    {
        ...
        summary: 'Scholarships for outstanding international students at UAE public universities.',
        description: 'The UAE offers competitive scholarships for bachelor’s and master’s programs in fields aligned with national priorities, including STEM and health sciences.',
    ...
    },
    {
        ...
        summary: 'Malaysian government scholarship for postgraduate study at Malaysian universities.',
        description: 'MIS invites talented international students to pursue master’s and PhD degrees in Malaysia with tuition and monthly allowances for successful candidates.',
    ...
    },
    {
        ...
        summary: 'Apply in-platform for partner-managed intake rounds with direct status tracking.',
        description: 'This partner program lets Afghan students submit a profile and motivation statement through AfScholarships. Our partner network reviews submissions and updates your application timeline in your dashboard.',
...
//# sourceMappingURL=scholarships.seed-data.js.map