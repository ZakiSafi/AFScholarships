...
let ApplicationsController = class ApplicationsController {
    ...
    createPartnerApplication(scholarshipId, user, payload) {
        return this.applicationsService.applyToPartnerScholarship(scholarshipId, user.userId, payload);
    }
    listMine(user) {
...
__decorate([
    (0, common_1.Post)('partner/:scholarshipId'),
    ...
    __metadata("design:paramtypes", [String, Object, create_partner_application_dto_1.CreatePartnerApplicationDto]),
